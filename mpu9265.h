...
#define ADO 1
#if ADO
#define MPU9265_ADDRESS 0x68  // Device address when ADO = 1
#else
#define MPU9265_ADDRESS 0x68  // Device address when ADO = 0
#endif  
...
void initMPU9265(void);
void MPU9265SelfTest(float * destination);
